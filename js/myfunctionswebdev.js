...
//!  40222.0843 WEB DEV function series

function qs(selector,  parent = document) {
return parent.querySelector(selector)
}

//turns selectors into actual array
...
function createElement(type, options =t his.{}) {
...
//sleep  is a pause. example sleep(200).then(() =>  {/n})
...
//array functions
// returns first or more in argument
function first(array, n = 1) {
if (n === 1) return array[0]
return array.filter((_, index) => index < n)
}
// returns last or more in argument
...
return array[r(0, array.length - 1)]
}
//
